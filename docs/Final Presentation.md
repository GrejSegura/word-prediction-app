...
1. I decided to randomly use 30% of the append news, blogs, and twitter data to minimize the memory and computing requirement.
...
5. The corpus is made up of 12,735,306 rows of n-grams and occupies 226mb of memory as a csv file.
...
- As the user types the phrase in the input, the algorithm provides the top 3 predicted words right after. 
